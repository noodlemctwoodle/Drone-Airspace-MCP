...
describe('MCP server end to end', () => {
  it('lists every tool with schemas', async () => {
    ...
    expect(tools.map((t) => t.name).sort()).toEqual(['check_drone_rules', 'check_location', 'check_notams', 'check_route', 'check_takeoff_site', 'check_terrain', 'check_weather', 'find_parking', 'find_takeoff_spots', 'geocode', 'get_aerodrome_zone', 'get_data_status', 'preflight_briefing']);
