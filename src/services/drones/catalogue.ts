...
export const DRONE_CATALOGUE: DroneModel[] = [
  ...
  { id: 'dji-phantom-4-pro-v2', make: DJI, model: 'Phantom 4 Pro V2.0', aliases: ['phantom 4 pro', 'p4p', 'p4 pro'], weightG: 1375, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2018, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-avata-360', make: DJI, model: 'Avata 360', aliases: ['avata360'], weightG: 455, euClass: 'C1', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'fpv', released: 2026, notes: 'Sold with a C1 label. FPV goggles need a competent observer to keep visual line of sight.', verified: V },
  ...
  // Older and enterprise DJI aircraft. Weights are the manufacturer's take-off weight with the standard battery.
  { id: 'dji-mavic-3-cine', make: DJI, model: 'Mavic 3 Cine', aliases: ['mavic3cine'], weightG: 899, euClass: 'C1', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2021, notes: 'C1 label added by DJI in 2023 with the Mavic 3.', verified: V },
  { id: 'dji-mavic-3-pro-cine', make: DJI, model: 'Mavic 3 Pro Cine', aliases: ['mavic3procine'], weightG: 963, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2023, notes: 'Sold with a C2 label.', verified: V },
  { id: 'dji-mavic-3-enterprise', make: DJI, model: 'Mavic 3 Enterprise', aliases: ['mavic 3e', 'mavic3e', 'm3e'], weightG: 915, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2022, notes: 'Enterprise series sold with a C2 label. The RTK module adds 24 g.', verified: V },
  { id: 'dji-mavic-3-thermal', make: DJI, model: 'Mavic 3 Thermal', aliases: ['mavic 3t', 'mavic3t', 'm3t'], weightG: 920, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2022, notes: 'Enterprise series sold with a C2 label.', verified: V },
  { id: 'dji-mavic-3-multispectral', make: DJI, model: 'Mavic 3 Multispectral', aliases: ['mavic 3m', 'mavic3m', 'm3m'], weightG: 951, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2022, notes: 'Enterprise series sold with a C2 label.', verified: V },
  { id: 'dji-mavic-2-enterprise', make: DJI, model: 'Mavic 2 Enterprise', aliases: ['mavic 2 enterprise zoom', 'm2e'], weightG: 905, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mavic', released: 2018, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-mavic-2-enterprise-dual', make: DJI, model: 'Mavic 2 Enterprise Dual', aliases: ['m2ed'], weightG: 899, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mavic', released: 2018, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-mavic-2-enterprise-advanced', make: DJI, model: 'Mavic 2 Enterprise Advanced', aliases: ['m2ea'], weightG: 909, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mavic', released: 2021, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-mavic-pro', make: DJI, model: 'Mavic Pro', aliases: ['mavic 1', 'mavicpro'], weightG: 734, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mavic', released: 2016, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-mavic-pro-platinum', make: DJI, model: 'Mavic Pro Platinum', aliases: ['mavic platinum'], weightG: 734, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mavic', released: 2017, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-mavic-air', make: DJI, model: 'Mavic Air', aliases: ['air 1', 'mavicair'], weightG: 430, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'air', released: 2018, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-spark', make: DJI, model: 'Spark', aliases: [], weightG: 300, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'mini', released: 2017, notes: 'No class mark: legacy aircraft under 2 kg, so A3 without an A2 CofC.', verified: V },
  { id: 'dji-phantom-4', make: DJI, model: 'Phantom 4', aliases: ['p4'], weightG: 1380, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2016, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-phantom-4-advanced', make: DJI, model: 'Phantom 4 Advanced', aliases: ['p4a'], weightG: 1368, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2017, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-phantom-4-rtk', make: DJI, model: 'Phantom 4 RTK', aliases: ['p4 rtk', 'p4rtk'], weightG: 1391, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2018, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-phantom-3-standard', make: DJI, model: 'Phantom 3 Standard', aliases: ['p3s'], weightG: 1216, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2015, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-phantom-3-advanced', make: DJI, model: 'Phantom 3 Advanced', aliases: ['p3a', 'phantom 3 4k'], weightG: 1280, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2015, notes: 'No class mark: legacy aircraft under 2 kg. The 4K model weighs the same.', verified: V },
  { id: 'dji-phantom-3-professional', make: DJI, model: 'Phantom 3 Professional', aliases: ['p3p'], weightG: 1280, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2015, notes: 'No class mark: legacy aircraft under 2 kg.', verified: V },
  { id: 'dji-inspire-2', make: DJI, model: 'Inspire 2', aliases: ['inspire2'], weightG: 3440, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'phantom', released: 2016, notes: 'Weight with batteries, no gimbal; the Zenmuse X5S or X7 adds up to about 0.6 kg. No class mark: legacy aircraft over 2 kg, so A3.', verified: V },
  { id: 'dji-inspire-3', make: DJI, model: 'Inspire 3', aliases: ['inspire3'], weightG: 3995, euClass: null, ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'phantom', released: 2023, notes: 'Class label not confirmed; check the aircraft. Treated as legacy over 2 kg, so A3.', verified: V },
  { id: 'dji-matrice-4e', make: DJI, model: 'Matrice 4E', aliases: ['m4e'], weightG: 1207, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2025, notes: 'Sold with a C2 label.', verified: V },
  { id: 'dji-matrice-4t', make: DJI, model: 'Matrice 4T', aliases: ['m4t'], weightG: 1238, euClass: 'C2', ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'mavic', released: 2025, notes: 'Sold with a C2 label.', verified: V },
  { id: 'dji-matrice-30', make: DJI, model: 'Matrice 30', aliases: ['m30'], weightG: 3770, euClass: null, ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'phantom', released: 2022, notes: 'Class label not confirmed; check the aircraft. Treated as legacy over 2 kg, so A3.', verified: V },
  { id: 'dji-matrice-30t', make: DJI, model: 'Matrice 30T', aliases: ['m30t'], weightG: 3770, euClass: null, ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'phantom', released: 2022, notes: 'Class label not confirmed; check the aircraft. Treated as legacy over 2 kg, so A3.', verified: V },
  { id: 'dji-matrice-300-rtk', make: DJI, model: 'Matrice 300 RTK', aliases: ['m300', 'm300 rtk'], weightG: 6300, euClass: null, ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'phantom', released: 2020, notes: 'Weight with two batteries, no payload; a Zenmuse H20 adds about 0.7 kg. No class mark: legacy aircraft, A3.', verified: V },
  { id: 'dji-matrice-350-rtk', make: DJI, model: 'Matrice 350 RTK', aliases: ['m350', 'm350 rtk'], weightG: 6470, euClass: null, ukClass: null, camera: true, remoteId: 'broadcast', silhouette: 'phantom', released: 2023, notes: 'Weight with two batteries, no payload. Class label not confirmed; treated as legacy, A3.', verified: V },
  { id: 'ryze-tello', make: 'Ryze', model: 'Tello', aliases: ['dji tello', 'tello edu'], weightG: 80, euClass: null, ukClass: null, camera: true, remoteId: 'none', silhouette: 'palm', released: 2018, notes: 'Under 100 g, so no Flyer ID is needed; a camera still means an Operator ID.', verified: V },
