export const CAVEAT_NOT_BRIEFING =
  'Informational only. Not a substitute for a NATS pre-flight briefing, the CAA Drone Code, or permission from the landowner and any relevant aerodrome.';
